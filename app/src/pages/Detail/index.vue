<template>
  <div class="detail">
    ...
    <section class="con">
      ...
      <!-- 主要内容区域 -->
      <div class="mainCon" v-if="skuInfo">
        <!-- 左侧放大镜区域 -->
...
<script>
  ...
  // var num=document.getElementsByClassName('itxt').value
  // 正则表达式，只能输入数字oninput="value=value.replace(/[^\d]/g,'')
  // if(!isNumber(num))
  // {
  // alert('请输入数字')
  // document.getElementsByClassName('itxt').value = ""; 
  // }
  export default {
    name: 'Detail',
    data(){
